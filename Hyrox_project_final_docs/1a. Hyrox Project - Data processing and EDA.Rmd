---
title: "Hyrox Project - Data Processing And EDA"
author: "Jojo Justine"
date: "2025-08-08"
output:
  html_document:
...
```{r}
# Set desired age group order manually
...
# Plot without legend or fill mapping
p <- ggplot(avg_time_by_age, aes(x = age_group, y = avg_total_time,
                                 text = paste("Age Group:", age_group,
                                              "<br>Avg Time:", round(avg_total_time, 2)))) +
  geom_col(fill = "steelblue") +  # consistent bar color
...
write_excel_csv(s5_filtered_df, "hyrox_results_updated.csv") # Top countries for open S5
